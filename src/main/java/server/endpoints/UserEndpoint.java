...
public class UserEndpoint {
    ...
    public Response createUser(String jsonUser) {
        ...
        try {
            ...
            return Response.status(501).type("text/plain").entity("").build();
        ...
        return Response.status(201).type("text/plain").entity("").build();
    ...
    public Response deleteUser(String jsonDeleteId) {
        ...
        return Response.status(200).type("text/plain").entity("").build();
    }
}
